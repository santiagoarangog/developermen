<?php $title = 'Developer Men &bull; Beta';
    ...
    <div class="container top">
      <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-7 text-center">
          ...
          <!-- Heading -->
          <h1 class="display- font-weight-bold text-white">
            Un subdominio perfecto para <br><span class="text-info" data-toggle="typed" data-options='{"strings": ["una E-Commerce","un Foro", "un Blog","una web Personal","un Directorio","una intranet","un sitio de modas", "una pizzeria", "un sitio de citas", "tu industria"]}'></span>.
          </h1>

          <!-- Text -->
          <p class="lead mb-0 text-white-75">
            Adquiere el subdominio perfecto para tu nuevo proyecto o tu proyecto ya existente
          </p>
        ...
        <div class="col-12">
          ...
          <form class="rounded shadow mb-4">
            <div class="input-group input-group-lg">
              ...
              <!-- Input -->
              <input type="text" class="form-control border-0 px-1" aria-label="Busca tu subdominio..." placeholder="Busca tu subdominio...">
