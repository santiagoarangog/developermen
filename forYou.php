<?php
$title = 'Tenemos un produco para tí Campoder &bull; Developer Men';
//Seo de La Pagina
$description = "Hola CAMPODER tenemos una cotización para tí...";
//Seo para facebook
$ogTitle = "Tenemos un produco para tí Campoder &bull; Developer Men";
$ogDescription="Hola CAMPODER tenemos una cotización para tí...";
...
$ogArticleTag="Tenemos un produco para tí Campoder &bull; Developer Men";
$ogArticleSection="Cotización";
$ogImage="https://developermen.com/assets/img/media/developerMenInicio.png";
//Seo para Twitter
$twitterDescription="Hola CAMPODER tenemos una cotización para tí...";
$twitterTitle="Tenemos un produco para tí Campoder &bull; Developer Men";
...
<body>
      ...
      <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8 text-center">
          ...
          <h1 class="display-3 font-weight-bold text-white">
            Hola CAMPODER, esta es tu cotización
          </h1>
          <br>
          <!-- Text -->
  ...
  ================================================== -->
  <section id="about">
    <div class="container bg-cover" style="background-image: url(assets/img/covers/bg-pattern.png);">
          ...
          <div class="card shadow-lg">
            <div class="card-body">
              ...
              <form class="d-flex align-items-center justify-content-center">
                ...
                <!-- Switch -->
                <div class="custom-control custom-switch custom-switch-primary mx-3">
              ...
              <div class="d-flex justify-content-center">
                ...
                <span class="price display-2 mb-0" data-annual="3300000" data-monthly="275000">3,300,000</span>
    ...
    <section class="slice slice-xl has-floating-items bg-dark text-light" id="sct-call-to-action" class="bg-cover" style="background-image: url(assets/img/patterns/pattern-1.svg);">
      <a href="#sct-call-to-action" class="tongue tongue-section-primary scrl-down" data-toggle="smooth-scroll">
        ...
        <section>
          <div class="row">
            <div class="col-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover rounded shadow-dark-lg">
                  <thead>
                    <tr>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <tr>
                        <td colspan="3">Costo Web Empresarial Developer Men</td>
                        <td>$ 3,500,000"</td>
                      </tr>
                      <tr>
                        <td colspan="3">Descuento <span class="text-info font-weight-bold" data-toggle="tooltip" data-placement="top" title="Esta promoción solo cobija a aquellas organizaciones o personas que adquieran los planes web Profesional y/o Empresarial"> new user Developer Men </span></td>
                        <td>$ 200,000"</td>
                      </tr>
                      <tr>
                        <td colspan="3" class="font-weight-bold">Costo total del producto</td>
                        <td>$ 3,300,000"</td>
                      </tr>
                    </tbody>
                  </table>
          ...
          <div class="container floating-items">
            <div class="icon-floating bg-white floating">
              <span></span>
              <img alt="Image placeholder" src="assets/img/icons/startup.png" width="70" class="img-fluid svg-inject">
            </div>
            <div class="icon-floating icon-lg bg-white floating">
              <span></span>
              <img alt="Image placeholder" src="assets/img/icons/amor.png" width="90" class="img-fluid svg-inject">
            </div>
            <div class="icon-floating icon-sm bg-white floating">
              <span></span>
              <img alt="Image placeholder" src="assets/img/icons/coding.png" width="70" class="img-fluid svg-inject">
            </div>
            <div class="icon-floating icon-lg bg-white floating">
              <span></span>
              <img alt="Image placeholder" src="assets/img/icons/united.png" width="70" class="img-fluid svg-inject">
            </div>
            <div class="icon-floating bg-white floating">
              <span></span>
              <img alt="Image placeholder" src="assets/img/icons/protection.png" width="70" class="img-fluid svg-inject">
            </div>
            <div class="icon-floating icon-sm bg-white floating">
              <span></span>
              <img alt="Image placeholder" src="assets/img/icons/ideas.png" width="60" class="img-fluid svg-inject">
            </div>
          </div>
        </section>
        ...
        <div class="container py-6 py-md-8 border-top border-bottom border-gray-300">
          <div class="row align-items-center">
            <div class="col-12 col-md">
              ...
              <!-- Heading -->
              <h3 class="mb-1 font-weight-bold text-light">
                Descarga tu cotización en formato documento
              </h3>
            ...
            <div class="col-12 col-md-5 float-right">
              ...
              <form>
                <div class="row">
                  <!-- Button -->
                  <a href="javascript:;" class="btn btn-primary btn-block" data-fancybox data-type="iframe" data-src="https://developermen.com/assets/docs/Cotizacion_Web_Empresarial_CAMPODER.pdf">Descargar y/o visualizar</a>
                </div> <!-- / .row -->
                <p class="mb-0 font-size-sm text-center text-muted">Si no se visualiza correctamente da clic <a href="https://developermen.com/assets/docs/Cotizacion_Web_Empresarial_CAMPODER.pdf" target="_blank">aquí</a></p>
              </form>
            </div>
          </div> <!-- / .row -->
        </div> <!-- / .container -->
