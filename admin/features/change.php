...
<head>
  ...
  <title><?php echo isset($result['DS_NOMCOMPANIA'])?$result['DS_NOMCOMPANIA']:'' ?> Cambios &bull; Developer Men</title>
  <script src="../assets/js/localScripts.js" charset="utf-8"></script>
  <style type="text/css">
  @charset "UTF-8";
...
<body yahoo bgcolor="#ffffff" onload="limpiarGet();">
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="h2" style="text-align:center;">
                    ...
                    <?php echo isset($result['DS_NOMCOMPANIA'])?$result['DS_NOMCOMPANIA']:'' ?><br> Te avísamos que tú cambio solicitado se realizo correctamente
                  </td>
                </tr>
                <tr>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td class="bodycopy" style="text-align:justify;">
                    <?php echo isset($result['DS_CAMBIO'])?$result['DS_CAMBIO']:'' ?>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="bodycopy" style="text-align:center;">
                    ...
                    <a style="text-decoration:none;color:#646FCB;font-weight:bold;" href="<?php echo 'http://'.$result['DS_URL'];?>" target="_blank">Aquí</a>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td class="h2" style="text-align:center;font-size:15px;color:#fff;">
                    ...
                    <br>
                    <a style="text-decoration:none;color:#153643;" href="https://developermen.com/" target="_blank">&reg; Developer Men</a>, todos los derechos reservados <?php echo date('Y'); ?> <br/>
                    Si no puedes visualizar correctamente este mensaje <a style="text-decoration:none;color:#153643;" href="https://developermen.com/admin/features/change?oid=<?php echo isset($result['OIDCAMBIO'])?$result['OIDCAMBIO']:''; ?>">Accede aquí</a>
                  </td>
                </tr>
                <tr>
                </tr>
