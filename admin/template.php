...
if(!isset($_SESSION["session_username"]))
{
	...
	session_destroy();
           echo "<script>alert('La seccion expiro vuelve a loggearte');</script>";
           header("location:login.php?msg=seccionExpire");
      }
...
$title = "Administracion de listados || Developer Men";
