        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card ">
                <div class="header">
                  <h4 class="title"><i class="fa fa-list text-primary"></i> Gestionar facturación</h4>
                  <p class="category">Envia, analiza y gestiona la facturación de las compras realizadas</p>
                </div>
                <div class="content">
