        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card ">
                <div class="header">
                  <h4 class="title"><i class="pe-7s-ribbon text-primary"></i> Soluciona las incidencias</h4>
                  <p class="category">Soluciona las incidencias del usuario</p>
                </div>
                <div class="content">
                  ...
                  <br>
                  <?php
                  listarIncidenciaProgreso($_POST);
                  ?>
                  <div class="footer">
                    <div class="legend">
