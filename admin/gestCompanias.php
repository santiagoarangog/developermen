...
require('functions/gestCompanias.php');
$active = 'Productos';
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card ">
                <div class="header">
                  <h4 class="title"><i class="pe-7s-diamond text-primary"></i> Añade una compañia</h4>
                ...
                <div class="content">
                  <form action="" method="POST" class="form-inline">
                    ...
                    <div class="form-group mx-sm-4 mb-4" style="width:35%;">
                      ...
                      <input type="text" style="width:100%;" name="nomCompania" class="form-control" id="nomCompania" placeholder="Nombre de la compañia" value="<?php echo isset($_POST['nomDesti'])?$_POST['nomDesti']:''; ?>">
                    </div>
