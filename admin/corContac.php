        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12">
              <div class="card ">
                <div class="header">
                  <h4 class="title"><i class="fa fa-at text-success"></i> Gestionar correos de contactanos</h4>
                  <p class="category">Visualiza y da respuesta a los diversos correos de contactanos</p>
                </div>
                <div class="content">
                  ...
                  <div class="footer">
                    ...
                    <hr>
                    <div class="stats">
                      <i class="fa fa-envelope-o"></i> Correos de contactanos
                    </div>
                  </div>
                </div>
              </div>
