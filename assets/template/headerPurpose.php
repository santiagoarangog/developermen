...
<head>
  ...
  <link type="text/css" href="https://developermen.com/assets/libs/@fancyapps/fancybox/dist/jquery.fancybox.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://developermen.com/assets/css/styles.css?style=<?php echo filemtime('./assets/css/styles.css');?>"><!-- Font awesome -->
  <link rel="stylesheet" href="https://developermen.com/assets/libs/purpose/css/styles.css?style=<?php echo filemtime('./assets/libs/purpose/css/styles.css');?>"><!-- Font awesome -->
  <script src="./assets/libs/purpose/js/purpose.core.js?script=<?php echo filemtime('./assets/libs/purpose/js/purpose.core.js');?>"></script>
  <script src="https://developermen.com/assets/js/seguimiento.js?script=<?php echo filemtime('./assets/js/seguimiento.js');?>"></script>
</head>
