...
<head>
  ...
  <meta name="msapplication-TileImage" content="https://developermen.com/assets/favicons/mstile-144x144.png">
  <meta name="msapplication-config" content="https://developermen.com/assets/favicons/browserconfig.xml">
  ...
  <link rel="mask-icon" type="" href="https://developermen.com/assets/favicons/android-icon-192x192.png" color="#111" />
  <!-- Android Icons -->
  ...
  <!-- Theme CSS -->
  <link rel="stylesheet" href="https://developermen.com/assets/libs/purpose/css/purpose.css?style=<?php echo filemtime('../../assets/libs/purpose/css/purpose.css');?>">
  <link rel="stylesheet" href="https://developermen.com/assets/css/all.css?style=<?php echo filemtime('../../assets/css/all.css');?>"><!-- Font awesome -->
  <!-- Style's -->
  <!--[if IE]>
      ...
      <div class="container px-0">
        <div class="navbar-nav align-items-center">
          <div class="d-none d-lg-inline-block">
            <span class="navbar-text mr-3">Soporte &bull; Developer Men</span>
          </div>
          <div class="ml-auto">
            <ul class="nav">
          ...
          <div class="col px-0">
            <div class="row justify-content-center">
              <div class="col-lg-7 text-center">
                ...
                <h6 class="h1 my-4 text-white">Se ha enviado un correo a tu email ingresado</h6>
                <p class="px-md-5 text-white mb-5">
                  Ingresa a tu bandeja de entrada y sigue los pasos descriptos en el correo enviado
                </p>
                <button class="btn btn-white rounded-pill mt-4" type="button" onclick="self.close();">Cerrar ventana</button>
                <a class="btn btn-white rounded-pill mt-4" href="login">Ir al Log In <i class="fas fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
