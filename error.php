...
<body>
  ...
  <!-- CONTENT
  ================================================== -->
  <section class="section-border border-primary title">
    <div class="container d-flex flex-column">
      <div class="row align-items-center justify-content-center no-gutters min-vh-100">
        <div class="col-12 col-md-5 col-lg-4 py-8 py-md-11">
          <img src="assets/img/illustrations/Taken.svg" alt="..." class="img-fluid">

          <!-- Heading -->
          <h1 class="h2 font-weight-bold text-center">
            Error <span style="color:#E5483F;">404</span>
          </h1>

          <!-- Text -->
          <p class="mb-5 h5 text-center text-light">
            Nos encontramos con un problema, pero no se preocupe, lo solucionaremos con seguridad.
            <br>
            Verifica la <?php $url = parse_url($_SERVER['REQUEST_URI'],PHP_URL_PATH);
            echo "URL: <span style='color:#E56353;'> $url </span>";?>
          </p>
  ...
  */
  function popolate(num){
    ...
    */
    ...
    <script src="./assets/js/main.js?scripts=<?php echo filemtime('./assets/js/main.js');?>" charset="UTF-8"></script>
